  ...
  return (
    <div className="max-w-3xl mx-auto">
      <div className="text-center mb-10">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Professional Growth Challenges</h1>
        <p className="text-lg text-gray-600">Generate personalized challenges for your field and available time</p>
      </div>
